...
namespace _1_Reflection
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var fields =  type.GetFields(BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Instance);// 필드(맴버변수) 가져옴
            foreach (var field in fields)
            {
                ...
                Console.WriteLine($"{access} {field.FieldType.Name} {field.Name}"); //float = single
            }
